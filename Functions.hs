module Functions (getPosition, removeValueFromPossibleValues, removeAPossibleValue, setCorrectValue, setPossibleValues, setAllStartingValues, getGroupIdOfPosition, getGroupSizeOfPosition, isPositionInGroup, initBoard, createBoard, isValueSet, updatePossibleValuesBySetValuesInGroup, updatePossibleValuesBySetAdjecents, comparePossibleValuesWithinGroup, compareValue, suguruSolver) where
